...
Executable toy graph and trace checks live in `Examples/DFS.lean`.
...
recursive DFS. `Complexity.lean` proves one cost-independent DFS operation profile, then reuses it
